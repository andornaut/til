...
<!-- mdtoc -->
  ...
  * [RetroArch](docs/retroarch.md#retroarch)
    ...
    * [Recommended Games](docs/retroarch.md#recommended-games)
      ...
      * [Super Nintendo Entertainment System (SNES) - November 21, 1990](docs/retroarch.md#super-nintendo-entertainment-system-snes---november-21-1990)
    * [Troubleshooting](docs/retroarch.md#troubleshooting)
      * [Fix crashes when running a game](docs/retroarch.md#fix-crashes-when-running-a-game)
      * [Fix crashes when running a game on Nintendo GameCube/Dolphin](docs/retroarch.md#fix-crashes-when-running-a-game-on-nintendo-gamecubedolphin)
      * [Fix Nintendo GameCube/Dolphin copy/load error when running a game](docs/retroarch.md#fix-nintendo-gamecubedolphin-copyload-error-when-running-a-game)
      * [Fix "Failed to load content" error](docs/retroarch.md#fix-failed-to-load-content-error)
