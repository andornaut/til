...
<!-- mdtoc -->
  ...
  * [RetroArch](docs/retroarch.md#retroarch)
    ...
    * [Troubleshooting](docs/retroarch.md#troubleshooting)
      * [Fix Nintendo GameCube/Dolphin crash when running a game](docs/retroarch.md#fix-nintendo-gamecubedolphin-crash-when-running-a-game)
      ...
      * [Fix Sega Dreamcast/Flycast crash when running a game on Xbox Series](docs/retroarch.md#fix-sega-dreamcastflycast-crash-when-running-a-game-on-xbox-series)
