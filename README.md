...
[![Test](https://github.com/andornaut/til/actions/workflows/test.yml/badge.svg)](https://github.com/andornaut/til/actions/workflows/test.yml)
...
* [Android](docs/android.md#android)
  ...
  * [ADB Debugging](docs/android.md#adb-debugging)
    ...
    * [Force ADB server port to 5555](docs/android.md#force-adb-server-port-to-5555)
  ...
  * [Android TV / Google TV](docs/android.md#android-tv-google-tv)
    * [Projectivy Launcher](docs/android.md#projectivy-launcher)
      * [Installation and setup](docs/android.md#installation-and-setup)
        * [Launcher Manager workarounds](docs/android.md#launcher-manager-workarounds)
          * [Recommended: Install adb-auto-enable](docs/android.md#recommended-install-adb-auto-enable)
          * [Alternative: Manual ADB commands](docs/android.md#alternative-manual-adb-commands)
          * [Alternative: Temporarily bind ADB to port 5555](docs/android.md#alternative-temporarily-bind-adb-to-port-5555)
...
* [Apache](docs/apache.md#apache)
  ...
  * [Test the configuration](docs/apache.md#test-the-configuration)
  * [Enable and disable sites and modules](docs/apache.md#enable-and-disable-sites-and-modules)
  * [Logs](docs/apache.md#logs)
* [Artificial Intelligence (AI)](docs/artificial_intelligence.md#artificial-intelligence-ai)
  ...
  * [Models and leaderboards](docs/artificial_intelligence.md#models-and-leaderboards)
  * [Platforms](docs/artificial_intelligence.md#platforms)
  * [Software](docs/artificial_intelligence.md#software)
    * [Local inference](docs/artificial_intelligence.md#local-inference)
    * [Agent frameworks](docs/artificial_intelligence.md#agent-frameworks)
    * [Evaluation and observability](docs/artificial_intelligence.md#evaluation-and-observability)
...
* [bash](docs/bash.md#bash)
  ...
  * [Strict mode](docs/bash.md#strict-mode)
...
* [Cryptography](docs/cryptography.md#cryptography)
  ...
  * [Inspect a CSR or certificate](docs/cryptography.md#inspect-a-csr-or-certificate)
...
* [Docker](docs/docker.md#docker)
  ...
  * [Follow logs](docs/docker.md#follow-logs)
  * [Run a shell in a running container](docs/docker.md#run-a-shell-in-a-running-container)
  * [Show disk usage](docs/docker.md#show-disk-usage)
...
* [FPV](docs/fpv.md#fpv)
  ...
  * [Videos and YouTube Channels](docs/fpv.md#videos-and-youtube-channels)
  * [Websites](docs/fpv.md#websites)
    * [Stores](docs/fpv.md#stores)
  * [Betaflight modes](docs/fpv.md#betaflight-modes)
    * [Flight Modes](docs/fpv.md#flight-modes)
  * [Express LRS modes](docs/fpv.md#express-lrs-modes)
  * [How-tos](docs/fpv.md#how-tos)
    * [Betaflight](docs/fpv.md#betaflight)
      * [Backup Betaflight firmware](docs/fpv.md#backup-betaflight-firmware)
      * [Configure dynamic motor idle](docs/fpv.md#configure-dynamic-motor-idle)
      * [Flash Betaflight firmware](docs/fpv.md#flash-betaflight-firmware)
    * [RadioMaster TX15 Radio Controller](docs/fpv.md#radiomaster-tx15-radio-controller)
      * [Bind RadioMaster TX15 Radio Controller to ExpressLRS receiver](docs/fpv.md#bind-radiomaster-tx15-radio-controller-to-expresslrs-receiver)
      * [Configure S1 and S2 encoders on RadioMaster TX15 Radio Controller](docs/fpv.md#configure-s1-and-s2-encoders-on-radiomaster-tx15-radio-controller)
      * [Configure ExpressLRS transmission settings on a RadioMaster TX15 Radio Controller](docs/fpv.md#configure-expresslrs-transmission-settings-on-a-radiomaster-tx15-radio-controller)
        * [Notes](docs/fpv.md#notes)
      * [Flash ExpressLRS on RadioMaster TX15 Radio Controller](docs/fpv.md#flash-expresslrs-on-radiomaster-tx15-radio-controller)
    * [Bind DJI Goggles 3 to Pavo Pico II](docs/fpv.md#bind-dji-goggles-3-to-pavo-pico-ii)
* [Git](docs/git.md#git)
  * [How-tos](docs/git.md#how-tos)
    ...
    * [Recover a lost commit or branch](docs/git.md#recover-a-lost-commit-or-branch)
  ...
  * [Github](docs/git.md#github)
    * [Collapsible section markdown](docs/git.md#collapsible-section-markdown)
...
* [Go](docs/go.md#go)
  ...
  * [Common commands](docs/go.md#common-commands)
...
* [JSON](docs/json.md#json)
  ...
  * [Querying with jq](docs/json.md#querying-with-jq)
...
* [Kubernetes](docs/kubernetes.md#kubernetes)
  * [kubectl](docs/kubernetes.md#kubectl)
...
* [macOS](docs/macos.md#macos)
  ...
  * [Customizations](docs/macos.md#customizations)
    ...
    * [Dock show/hide](docs/macos.md#dock-showhide)
    ...
    * [Disable CMD+h from hiding windows](docs/macos.md#disable-cmdh-from-hiding-windows)
...
* [Make](docs/make.md#make)
  ...
  * [Useful flags](docs/make.md#useful-flags)
  * [.PHONY](docs/make.md#phony)
* [Man](docs/man.md#man)
...
* [MySQL](docs/mysql.md#mysql)
  * [Connect and explore](docs/mysql.md#connect-and-explore)
  * [Show table constraints](docs/mysql.md#show-table-constraints)
* [Networking](docs/networking.md#networking)
  * [Netplan](docs/networking.md#netplan)
  * [Install and configure NetworkManager](docs/networking.md#install-and-configure-networkmanager)
  ...
  * [Query DNS](docs/networking.md#query-dns)
  ...
  * [Enable the USB port on a Ruckus R610 wireless access point](docs/networking.md#enable-the-usb-port-on-a-ruckus-r610-wireless-access-point)
* [NPM](docs/npm.md#npm)
  * [Install Node and NPM using NVM](docs/npm.md#install-node-and-npm-using-nvm)
  * [Installing and auditing](docs/npm.md#installing-and-auditing)
...
* [PostgreSQL](docs/postgresql.md#postgresql)
  * [psql](docs/postgresql.md#psql)
  * [Show database and relation sizes](docs/postgresql.md#show-database-and-relation-sizes)
...
* [Python](docs/python.md#python)
  ...
  * [How-tos](docs/python.md#how-tos)
    ...
    * [Develop a non-redistributable (no setup.py) local package using Pipenv](docs/python.md#develop-a-non-redistributable-no-setup.py-local-package-using-pipenv)
...
* [Retro games](docs/retro-games.md#retro-games)
  * [Hardware](docs/retro-games.md#hardware)
    * [Anbernic RG35XX+](docs/retro-games.md#anbernic-rg35xx)
      * [MinUI](docs/retro-games.md#minui)
        * [Notes](docs/retro-games.md#notes)
    ...
    * [Retroid Pocket Flip 2](docs/retro-games.md#retroid-pocket-flip-2)
  ...
  * [RetroArch](docs/retro-games.md#retroarch)
    * [Ansible](docs/retro-games.md#ansible)
    * [Multi-disc games](docs/retro-games.md#multi-disc-games)
      * [PSP is the one system with no working multi-disc layout](docs/retro-games.md#psp-is-the-one-system-with-no-working-multi-disc-layout)
    ...
    * [Cores](docs/retro-games.md#cores)
      ...
      * [Zipped ROMs and `block_extract`](docs/retro-games.md#zipped-roms-and-block_extract)
      * [Cores rot when the runtime moves](docs/retro-games.md#cores-rot-when-the-runtime-moves)
    * [Drivers](docs/retro-games.md#drivers)
      * [Why the global video driver stays glcore](docs/retro-games.md#why-the-global-video-driver-stays-glcore)
      * [Core options are a different file](docs/retro-games.md#core-options-are-a-different-file)
    * [Lightgun and menu pointer](docs/retro-games.md#lightgun-and-menu-pointer)
    * [Savestates](docs/retro-games.md#savestates)
    * [Rewind](docs/retro-games.md#rewind)
      * [Bind it three ways](docs/retro-games.md#bind-it-three-ways)
      * [Rewind buffer size](docs/retro-games.md#rewind-buffer-size)
      * [Only enable rewind for certain cores](docs/retro-games.md#only-enable-rewind-for-certain-cores)
    * [Input latency: preemptive frames](docs/retro-games.md#input-latency-preemptive-frames)
    * [Latency: swapchain images](docs/retro-games.md#latency-swapchain-images)
    * [Fullscreen and VRR](docs/retro-games.md#fullscreen-and-vrr)
    * [Shaders](docs/retro-games.md#shaders)
      * [CRT Geom Deluxe on the Flip 2](docs/retro-games.md#crt-geom-deluxe-on-the-flip-2)
    * [Thumbnails](docs/retro-games.md#thumbnails)
    * [Video drivers](docs/retro-games.md#video-drivers)
  * [Games](docs/retro-games.md#games)
    * [Arcade](docs/retro-games.md#arcade)
    * [Atari - 2600 - September 11, 1977](docs/retro-games.md#atari-2600-september-11-1977)
    ...
    * [SNK - Neo Geo Pocket Color (NGPC) - March 19, 1999](docs/retro-games.md#snk-neo-geo-pocket-color-ngpc-march-19-1999)
...
* [Ruby](docs/ruby.md#ruby)
  ...
  * [Gems and bundler - package management and dependencies](docs/ruby.md#gems-and-bundler-package-management-and-dependencies)
...
* [Rust](docs/rust.md#rust)
  ...
  * [Cargo](docs/rust.md#cargo)
    * [Cargo.toml overriding direct and transitive dependencies](docs/rust.md#cargo.toml-overriding-direct-and-transitive-dependencies)
...
* [Ubuntu](docs/ubuntu.md#ubuntu)
  * [Applications](docs/ubuntu.md#applications)
  ...
  * [Packages](docs/ubuntu.md#packages)
    * [Repositories](docs/ubuntu.md#repositories)
  ...
  * [Kernel and drivers](docs/ubuntu.md#kernel-and-drivers)
    ...
    * [Install kernel module (driver) for Realtek r8125 2.5G ethernet](docs/ubuntu.md#install-kernel-module-driver-for-realtek-r8125-2.5g-ethernet)
  ...
  * [Debugging and troubleshooting](docs/ubuntu.md#debugging-and-troubleshooting)
    ...
    * [Redshift.conf is not read when it is a symlink](docs/ubuntu.md#redshift.conf-is-not-read-when-it-is-a-symlink)
...
* [Woodworking](docs/woodworking.md#woodworking)
  * [Wood (lumber)](docs/woodworking.md#wood-lumber)
    ...
    * [Cost of wood](docs/woodworking.md#cost-of-wood)
      * [Nominal vs actual size](docs/woodworking.md#nominal-vs-actual-size)
